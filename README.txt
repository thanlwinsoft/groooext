The Graphite Extension for OpenOffice.org enables the Graphite Font Rendering
functionality in OpenOffice 3.2 and above to be enabled and disabled and makes
it easy to use Graphite Font Features.
